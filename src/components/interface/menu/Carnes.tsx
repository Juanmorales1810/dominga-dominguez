...
export default function Carnes(props: Props) {
    ...
    return (
        ...
        <section>
            <div className="container mx-auto md:px-4 py-20">
                ...
                >
                    Carnes
                    <Beef size={32} className="inline-block ml-2 mb-1.5" />
                </h1>
                <p className="text-center max-w-xl mx-auto text-balance text-gray-300 mb-8">
                    Opciones incluyen un acompañamiento: arroz, papas mayo, ensalada
                    chilena o ensalada surtida.
                </p>
