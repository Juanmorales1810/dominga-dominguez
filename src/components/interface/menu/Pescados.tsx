...
export default function Pescados(props: Props) {
    ...
    return (
        <section>
            <div className="container mx-auto md:px-4 py-10">
                ...
                >
                    Pescados
                    <FishIcon size={32} className="inline-block ml-2 mb-1" />
                </h1>
                <p className="text-center max-w-xl mx-auto text-balance text-gray-300 mb-8">
                    (La disponibilidad de nuestros productos depende de la temporada,
                    vedas y meteorología) (opciones incluyen un acompañamiento: arroz,
                    papas mayo, ensalada chilena o ensalada surtida).
                </p>
